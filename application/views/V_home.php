                    ...
                    <div class="projects-holder">
                        <div class="row">
                            <div class="col-md-3 col-sm-6 project-item mix workspace">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?php echo base_url('assets/'); ?>img/portfolio_01.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?php echo base_url('assets/'); ?>img/portfolio_big_01.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix workspace">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?php echo base_url('assets/'); ?>img/portfolio_02.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?php echo base_url('assets/'); ?>img/portfolio_big_02.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix technology">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?php echo base_url('assets/'); ?>img/portfolio_03.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?php echo base_url('assets/'); ?>img/portfolio_big_03.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix city">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?php echo base_url('assets/'); ?>img/portfolio_04.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?php echo base_url('assets/'); ?>img/portfolio_big_04.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix nature">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?php echo base_url('assets/'); ?>img/portfolio_05.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?php echo base_url('assets/'); ?>img/portfolio_big_05.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix technology">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?php echo base_url('assets/'); ?>img/portfolio_06.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?php echo base_url('assets/'); ?>img/portfolio_big_06.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix workspace">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?php echo base_url('assets/'); ?>img/portfolio_07.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?php echo base_url('assets/'); ?>img/portfolio_big_07.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix city">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="<?php echo base_url('assets/'); ?>img/portfolio_08.jpg">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="<?php echo base_url('assets/'); ?>img/portfolio_big_08.jpg" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                        </div>
    ...
    <div id="contact" class="page-section">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="map">
                        <img src="<?php echo base_url('assets/'); ?>img/map.jpg" alt="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row">
